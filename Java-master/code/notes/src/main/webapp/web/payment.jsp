...
<form action="pay_success.html" method="post" id="pay_form">
    <div id="container" class="clearfix" >
        ...
        <div class="pay_info">
            ...
            <span>支付订单：324235435 收款方：SISO商城</span><input type="hidden" name="orderId" />
        </div>
        <!--支付方式-->
        <div id="pay_type">
            <!-- 支付方式头-->
        ...
        <span class="pay_leftTime">
            ...
            <span class="okPay"><a href="${pageContext.request.contextPath }/web/pay_success.jsp" class="acti">立即付款</a></span>
