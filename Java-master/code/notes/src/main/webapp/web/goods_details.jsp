			...
			<div class="all">
				...
				<div id="sale_protection">
					...
					<div class="sale_content">
						...
						<p class="content">SISOSISO商城向您保证所售商品均为正品行货，SISO自营商品开具机打发票或电子发票。</p>
						...
						<p class="content">
							凭质保证书及SISO商城发票，可享受全国联保服务，与您亲临商场选购的商品享受相同的质量保证。SISO商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！
				...
				<div id="packing_list">
					...
					<p class="content">笔记本 x1 适配器 x1 电源线 x1 电池 x1 说明书（电子版）x1
						...
						如果您需要核实此电脑的具体配置型号是否与SISO页面相符，可电话咨询SISO厂商：800-858-2969</p>
				</div>
			</div>
		</div>
		<div class="right rt">
