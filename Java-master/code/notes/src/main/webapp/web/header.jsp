...
<header id="top" class="fixed_nav">
    ...
    <div class="rt">
        <ul class="lf">
            ...
            <li><a href="${pageContext.request.contextPath }/web/favorites.jsp" title="我的收藏"><img class="care" src="../images/header/care.png" alt=""/></a><b>|</b></li>
            <li><a href="${pageContext.request.contextPath }/web/orders.jsp" title="我的订单"><img class="order" src="../images/header/order.png" alt=""/></a><b>|</b></li>
            ...
            <li><a href="../web/help.jsp">帮助</a><b>|</b></li>
