...
public class StringUtil {
   ...
   /**
      * zeroToSpace("0"和"00"和"000"的空符串变换)
     */
   ...
   /**
      * formatPercentNumber(数字906 --> 906%的格式转换)
     */
    ...
    //formatRate(数字ZZ.ZZ ----> Z9.999的格式转换)
   ...
   /**
     * 
      * addBackFullSpace(在最后添加全角空格并返回字符串)
     *
    */
   ...
   /**
      * listToStringArray(List〈String〉转字符串数组)
     *
    */
   ...
   /**
      * listToSQLString(以逗号分隔把List〈String〉转成SQL使用的字符串)
     *
    */
