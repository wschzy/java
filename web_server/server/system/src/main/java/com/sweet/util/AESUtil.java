...
public class AESUtil {
    public static final String SEED = "hzy19981101ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz";
    public static void main(String[] args) throws Exception {
        String str = "user=胡子扬&pwd=admin";
        byte[] byteRe = enCrypt(str, SEED);
        ...
        System.out.println("解密后：" + deCrypt(encrytByte, SEED));
    }
    ...
    private static byte[] enCrypt(String content, String strKey) throws Exception {
        ...
        cByte = c.doFinal(content.getBytes("UTF-8"));
